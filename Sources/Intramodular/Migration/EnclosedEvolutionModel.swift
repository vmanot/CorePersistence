...
public protocol EnclosedEvolutionModel: VersionedModel {
    
}

/// An enclosed evolution model that establishes a migration step between a previous version of its model and itself.
public protocol EnclosedMigrationModel: EnclosedEvolutionModel {
    associatedtype PreviousModel: EnclosedEvolutionModel where PreviousModel.ModelVersion == ModelVersion
