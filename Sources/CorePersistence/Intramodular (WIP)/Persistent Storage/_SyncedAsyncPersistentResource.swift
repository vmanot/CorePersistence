...
public final class _SyncedAsyncPersistentResource<Coordinator: _AsyncPersistentResourceCoordinator> {
    ...
    ) async where Coordinator: _MutableAsyncPersistentResourceCoordinator {
