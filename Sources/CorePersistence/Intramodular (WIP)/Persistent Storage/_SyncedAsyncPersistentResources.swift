...
// TODO: Rename ResourceCoordinators to ResourcesProducer maybe and introduce _AsyncPersistentResourcesProducer to expose rules of engagement (latency etc.)?
public final class _SyncedAsyncPersistentResources<ResourceCoordinators: AsyncSequence>: ObservableObject where ResourceCoordinators.Element: _AsyncPersistentResourceCoordinator {
    ...
    public typealias Element = _SyncedAsyncPersistentResource<ResourceCoordinator>
