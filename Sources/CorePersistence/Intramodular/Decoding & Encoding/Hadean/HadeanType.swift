...
public struct HadeanType<T: Sendable>: Sendable {
    ...
    public init(_ type: T) throws {
        ...
        do {
            self.typeIdentifier = try _HadeanSwiftTypeRegistry[base.first].unwrap()
        } catch {
            assertionFailure()
    ...
    public init(_ type: T, id: HadeanIdentifier) throws {
        ...
        _HadeanSwiftTypeRegistry.register(base.first, forIdentifier: id)
...
extension HadeanType: Codable {
    public init(from decoder: Decoder) throws {
        ...
        do {
            type = try _HadeanSwiftTypeRegistry[typeIdentifier].unwrap()
        } catch {
            assertionFailure()
